...
## CODIGO PARA DESCARGAR LA BASE DE DATOS DE LA SABERERES 11 UNIDAS 
```{r}
write.table(saber11, "C:/Users/eduar/Downloads/saber11.txt", sep = ";", row.names = FALSE, na = "NA", quote = FALSE)
```

## PARA CARGAR LA BASE DE DATOS DE DATOS DE LA SABERES 11 UNIDAS
```{r}
saber11 <- read.delim("C:/Users/eduar/OneDrive/Escritorio/BASES DE DATOS LIMPIAS/saber11.txt", sep = ";", header = TRUE)
```

## CODIGO PARA DESCARGAR LA BASE DE DATOS DE LA SABERERES PRO UNIDAS 
```{r}
write.table(saberpro_total, "C:/Users/eduar/Downloads/saberpro_total.txt", sep = ";", row.names = FALSE, na = "NA", quote = FALSE)
```

## PARA CARGAR LA BASE DE DATOS DE DATOS DE LA SABERES PRO UNIDAS
```{r}
saberpro_total <- read.delim("C:/Users/eduar/OneDrive/Escritorio/BASES DE DATOS LIMPIAS/saberpro_total.txt", sep = ";", header = TRUE)
```

## CODIGO PARA DESCARGAR LA BASE DE DATOS final sin limpieza de respuestas 
```{r}
write.table(base_final, "C:/Users/eduar/Downloads/base_final.txt", sep = ";", row.names = FALSE, na = "NA", quote = FALSE)
```

## PARA CARGAR LA BASE DE DATOS final sin limpieza de respuestas
```{r}
base_final <- read.delim("C:/Users/eduar/OneDrive/Escritorio/BASES DE DATOS LIMPIAS/base_final.txt", sep = ";", header = TRUE)
```


## CODIGO PARA DESCARGAR LA BASE DE DATOS final CON limpieza de respuestas 
```{r}
write.table(base_final_limpia, "C:/Users/eduar/Downloads/base_final_limpia.txt", sep = ";", row.names = FALSE, na = "NA", quote = FALSE)
```

## PARA CARGAR LA BASE DE DATOS final CON limpieza de respuestas
```{r}
base_final_limpia <- read.delim("C:/Users/eduar/OneDrive/Escritorio/BASES DE DATOS LIMPIAS/base_final_limpia.txt", sep = ";", header = TRUE)
```
